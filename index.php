...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="index.php">Fonksiyonlar</a></h1>
      <p>Mehmet Fırat</p>
    </div>
    <div class="fl_right">
...
<div class="wrapper">
  <div id="slider">
    <div id="slide-wrapper" class="rounded clear"> 
      <!-- ################################################################################################ -->
      <figure id="slide-1"><a class="view" href="#"><img src="images/demo/slider/1(1).png" alt=""></a>
        <figcaption>
          <h2>Uygulama 1</h2>
          <p>Fonksiyon Uygulaması 1</p>
          <!-- Kodların Başı -->
          <p>
            <?php
          ...
          <!-- Kodların Sonu -->
          <p class="right"><a href="#">Okumaya Devam Et &raquo;</a></p>
        </figcaption>
      </figure>
      <figure id="slide-2"><a class="view" href="#"><img src="images/demo/slider/2.png" alt=""></a>
        <figcaption>
          <h2>Uygulama 2</h2>
          <p>Fonksiyon Uygulaması 2</p>
          <p>
            <?php
            function tablo(){
              echo "<table>";
              echo "<tr>";
              echo "<td>"; echo "Sanal Kart Numarası"; echo "</td>";
              echo "<td>"; echo "1111 1111 1111 0000"; echo "</td>";
              echo "</tr>";
              echo "<tr>";
              echo "<td>"; echo "Son Kullanım Tarihi"; echo "</td>";
              echo "<td>"; echo "09/27"; echo "</td>";
              echo "</tr>";
              echo "<tr>";
              echo "<td>"; echo "cvv"; echo "</td>";
              echo "<td>"; echo "2363"; echo "</td>";
              echo "</tr>";
              echo "</table>";
      ...
      <figure id="slide-3"><a class="view" href="#"><img src="images/demo/slider/3.png" alt=""></a>
        <figcaption>
          <h2>Uygulama 3</h2>
          <p>Fonksiyon Uygulaması 3</p>
          <p>
            <?php
            function tabloyap($satir, $sutun){
              echo "<table>";
              for($i=1;$i<=$satir;$i++){
                echo "<tr>";
                for($l=1;$l<=$sutun;$l++){
      ...
      <figure id="slide-4"><a class="view" href="#"><img src="images/demo/slider/4.png" alt=""></a>
        <figcaption>
          <h2>Uygulama 4</h2>
          <p>Fonksiyon Uygulaması 4</p>
          <p>
            <?php
            function dolarCevir($tutar){
              $dCeviri=$tutar/8;
              echo  "$tutar TL'nin Dolar Miktarı:".number_format($dCeviri,2,'.')."$<br>";
              }
              function euroCevir($tutar){
              $eCeviri=$tutar/10;
              echo " $tutar TL'nin Euro Miktarı:".number_format($eCeviri,2,'.')." € <br>";
              }
              function sterlinCevir($tutar){
              $sCeviri=$tutar/12;
              echo " $tutar TL'nin Sterlin Miktarı:".number_format($sCeviri,2,'.')." £ ";
              }
              $turkLirasi=3600;
